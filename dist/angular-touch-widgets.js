...
"use strict";
angular.module('angularTouchWidgets.directives.colorIntensity', []).directive('colorIntensity', function() {
  return {
    restrict: "E",
    replace: true,
    scope: {intensity: '='},
...
"use strict";
angular.module('angularTouchWidgets.directives.lightEditor', []).directive('lightEditor', function() {
  return {
    restrict: "E",
    replace: true,
    scope: {
...
"use strict";
angular.module('angularTouchWidgets.directives.minutesEditor', []).directive('minutesEditor', function() {
  return {
    restrict: "E",
    scope: {
      time: '=',
...
"use strict";
angular.module('angularTouchWidgets.directives.minutesPicker', []).directive('minutesPicker', function() {
  return {
    restrict: "E",
    scope: {time: '='},
...
"use strict";
angular.module('angularTouchWidgets.directives.orpMeter', []).directive('orpMeter', function() {
  return {
    restrict: "E",
    scope: {orp: '='},
    replace: true,
...
"use strict";
angular.module('angularTouchWidgets.directives.phMeter', []).directive('phMeter', function() {
  return {
    restrict: "E",
    scope: {ph: '='},
    replace: true,
...
"use strict";
angular.module('angularTouchWidgets.directives.thermometer', []).directive('thermometer', function() {
  return {
    restrict: "E",
    scope: {
      actualTemp: '=',
...
"use strict";
angular.module('angularTouchWidgets.directives.timePicker', []).directive('timePicker', function() {
  return {
    restrict: "E",
    scope: {
      from: '=',
